...
<style lang="scss" scoped>
	ul{
		>li{
			...
			.lt{ width: 50px; text-align: center;}
			.ct{
				margin-right: auto; display: flex; flex-direction: column; width: 100%; justify-content: space-between;padding: 6px 0;  border-bottom: 1px solid #ededed;
